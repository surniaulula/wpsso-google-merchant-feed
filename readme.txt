...
If using WooCommerce, note that WooCommerce product variations, attributes, meta data, and custom fields are fully supported.
...
**Version 5.0.0-dev.2 (2023/01/11)**
