...
_x( 'Google Merchant Feed XMLs for WooCommerce, Easy Digital Downloads, and Custom Products with Multilingual Support.', 'plugin description', 'wpsso-google-merchant-feed' );
