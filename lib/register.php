...
if ( ! class_exists( 'WpssoGmfRegister' ) ) {

	class WpssoGmfRegister {

		public function __construct() {

			register_activation_hook( WPSSOGMF_FILEPATH, array( $this, 'network_activate' ) );

			register_deactivation_hook( WPSSOGMF_FILEPATH, array( $this, 'network_deactivate' ) );
		...
		private function activate_plugin() {
			...
			WpssoGmfRewrite::add_rules();	// Adds and flushes rewrite rules only if necessary.
		}
