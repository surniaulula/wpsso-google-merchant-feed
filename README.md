...
<p>WooCommerce product variations, attributes, meta data, and custom fields are all fully supported. Fixes the "<em>Price Mismatched value (page crawl): (price [price])</em>" error in Google Merchant for WooCommerce product variations.</p>
